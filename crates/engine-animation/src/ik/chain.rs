...
pub mod chains {
    ...
    pub fn arm_right(hand: BoneIndex, forearm: BoneIndex, upper_arm: BoneIndex, shoulder: BoneIndex) -> IkChain {
    ...
    pub fn arm_left(hand: BoneIndex, forearm: BoneIndex, upper_arm: BoneIndex, shoulder: BoneIndex) -> IkChain {
    ...
    pub fn leg_right(foot: BoneIndex, shin: BoneIndex, thigh: BoneIndex, hip: BoneIndex) -> IkChain {
...
mod tests {
    ...
    fn chain_tip_base_accessors() {
        let chain = IkChain::new("leg", vec![BoneIndex(3), BoneIndex(2), BoneIndex(1), BoneIndex(0)]);
    ...
    fn chain_serialize_roundtrip() {
        let chain = IkChain::new("arm_r", vec![BoneIndex(7), BoneIndex(6), BoneIndex(5), BoneIndex(4)]);
