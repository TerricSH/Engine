...
mod shaders_embedded {
    ...
    // `TRIANGLE_FRAG_SPV` as `&'static [u8]`. The constants are empty
    // when the artifacts haven't been produced yet — the renderer
...
pub use renderer::{VulkanRenderer, VulkanRendererDescriptor};
