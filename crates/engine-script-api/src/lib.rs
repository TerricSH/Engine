...
pub const GAMEPLAY_SCRIPT_API_VERSION: &str = "0.17.0";
...
/// Multiplayer/session and read-only OpenXR gameplay bridge.
pub const GENERATED_CSHARP_ONLINE_XR_FILE: &str = "EngineOnlineXr.cs";
...
pub struct GameplayScriptApiContract {
    ...
    pub generated_csharp_online_xr_file: &'static str,
...
pub const GAMEPLAY_SCRIPT_API: GameplayScriptApiContract = GameplayScriptApiContract {
    ...
    generated_csharp_online_xr_file: GENERATED_CSHARP_ONLINE_XR_FILE,
...
mod tests {
    ...
    fn gameplay_contract_is_explicit_and_versioned() {
        ...
        assert_eq!(GAMEPLAY_SCRIPT_API.version, "0.17.0");
        ...
        assert!(GAMEPLAY_SCRIPT_API
            ...
            .ends_with(".cs"));
        assert!(GAMEPLAY_SCRIPT_API
            .generated_csharp_online_xr_file
            .ends_with(".cs"));
        assert!(GAMEPLAY_SCRIPT_API
